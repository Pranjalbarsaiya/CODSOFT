...
public class Quiz extends JFrame implements ActionListener {
    ...
    Quiz(String username) {
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("Quizicons/quizz.png"));
        JLabel image = new JLabel(i1);
        image.setBounds(0, 0, 1500, 400);
        add(image);

        quesnum = new JLabel();
        quesnum.setBounds(100, 450, 50, 30);
        quesnum.setFont(new Font("Times New Roman", Font.BOLD, 24));
        quesnum.setForeground(Color.WHITE);
        add(quesnum);
        ...
        questions[0][0] = "Programming Language Java was developed by?";
        questions[0][1] = "Paun Allen";
        questions[0][2] = "Mark Zuckerberg";
        questions[0][3] = "James Gosling";
        questions[0][4] = "Jeffrey Bezos";
